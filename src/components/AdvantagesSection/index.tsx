...
interface AdvantageProps extends MotionProps {
  title: string;
  text: string;
  buttonText: string;
  url: string;
...
const Advantage = React.forwardRef<HTMLAnchorElement, AdvantageProps>(
  ({ buttonText, text, url, title, ...rest }, ref) => {
    return (
      <motion.a ref={ref} {...rest} href={url} className={style['advantage']}>
